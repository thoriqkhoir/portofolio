  ...
  return (
    <div className="bg-transparent text-foreground">
      <div className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-full flex justify-center pointer-events-none">
        <div
          className={
            `pointer-events-auto backdrop-blur-md bg-white/10 dark:bg-black/20 border border-white/20 dark:border-white/10 rounded-2xl shadow-lg px-6 py-2 flex transition-transform duration-150 ease-out ${isPressed ? 'translate-y-2' : ''}`
          }
          style={{ maxWidth: '98vw' }}
