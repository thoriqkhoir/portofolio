    ...
    >
      ...
      <div className="space-y-2 sm:space-y-4 text-left pl-0 sm:pl-8" ref={containerRef} style={{position: 'relative'}}>
        ...
        >
            <button
              type="button"
              className="w-full sm:w-auto bg-white hover:bg-purple-100 hover:scale-110 font-bold px-6 sm:px-8 py-2 sm:py-3 rounded-full transition-transform duration-200 text-sm sm:text-base"
              onClick={() => {
