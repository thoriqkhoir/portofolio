...
const GooeyNav: React.FC<GooeyNavProps> = ({
  ...
  const handleClick = (e: React.MouseEvent<HTMLAnchorElement>, index: number) => {
    ...
    // Smooth scroll to target section with small offset for navbar height
    if (href.startsWith('#')) {
  ...
  const handleKeyDown = (e: React.KeyboardEvent<HTMLAnchorElement>, index: number) => {
    if (e.key === 'Enter' || e.key === ' ') {
      e.preventDefault();
      // Use the anchor itself to trigger smooth scroll
      handleClick(
        {
      ...
      <style>
        {`
          :root {
            ...
            --color-1: #60a5fa; /* blue-400 */
            --color-2: #a78bfa; /* purple-400 */
            --color-3: #22d3ee; /* cyan-400 */
            --color-4: #ffffff; /* pink-400 */
          }
          .effect {
            position: absolute;
            opacity: 1;
          ...
          .effect.filter {
            filter: blur(6px) contrast(120%) saturate(1.1);
          ...
          .particle {
            ...
            top: calc(50% - 8px);
            left: calc(50% - 8px);
            animation: particle calc(var(--time)) var(--linear-ease) 1 -350ms;
          }
          .point {
            background: var(--color);
            opacity: 1;
            animation: point calc(var(--time)) var(--linear-ease) 1 -350ms;
          }
          @keyframes particle {
            0% {
